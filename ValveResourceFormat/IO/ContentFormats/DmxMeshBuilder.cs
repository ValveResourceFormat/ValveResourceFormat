...
internal readonly record struct DmxMeshBuildOptions
{
    ...
    /// <summary>The skeleton the mesh's BLENDINDICES reference, used to find the generated cloth proxy bones.</summary>
...
internal static class DmxMeshBuilder
{
        ...
        in VertexStreams streams, bool isToolsBuffer = false, List<int>? clothTriangles = null)
    {
        ...
        if (!isToolsBuffer)
        {
            ...
            DropClothProxyInfluences(boneWeightCount, streams.ClothCompaction, clothBlendIndices, clothBlendWeights);
        }
    }
    ...
    /// <summary>
    /// Paints the vertices that kept no cloth weight but sit within <see cref="ClothEnableGrowthRings"/> rings of face
    /// adjacency of one that did. A vertex already painted keeps its paint.
    /// </summary>
