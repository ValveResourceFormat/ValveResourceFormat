...
#pragma warning restore CA1027
    ...
    public readonly struct Joint
    {
        ...
        /// <summary>Index into <see cref="PhysAggregateData.Parts"/> for the first body.</summary>
        public int Body1 { get; }
        /// <summary>Index into <see cref="PhysAggregateData.Parts"/> for the second body.</summary>
        public int Body2 { get; }
        /// <summary>Gets the joint flags.</summary>
        public JointFlags Flags { get; }
        /// <summary>The joint frame local to the first body, as (position, scale, rotation).</summary>
        public (Vector3 Position, float Scale, Quaternion Rotation) Frame1 { get; }
        /// <summary>The joint frame local to the second body, as (position, scale, rotation).</summary>
        public (Vector3 Position, float Scale, Quaternion Rotation) Frame2 { get; }
        /// <summary>Gets whether the two connected bodies still collide with each other.</summary>
        public bool EnableCollision { get; }
        /// <summary>Gets whether the linear degrees of freedom are locked out entirely.</summary>
        public bool IsLinearConstraintDisabled { get; }
        /// <summary>Gets whether the angular degrees of freedom are locked out entirely.</summary>
        public bool IsAngularConstraintDisabled { get; }
        /// <summary>Gets whether <see cref="LinearLimit"/> is enforced.</summary>
        public bool EnableLinearLimit { get; }
        /// <summary>Gets the linear motion limit along the joint axis.</summary>
        public Range LinearLimit { get; }
        /// <summary>Gets whether the linear motor is enabled.</summary>
        public bool EnableLinearMotor { get; }
        /// <summary>Gets the target linear velocity driven by the linear motor.</summary>
        public Vector3 LinearTargetVelocity { get; }
        /// <summary>Gets the maximum force the linear motor may apply.</summary>
        public float MaxForce { get; }
        /// <summary>Gets whether <see cref="SwingLimit"/> is enforced.</summary>
        public bool EnableSwingLimit { get; }
        /// <summary>Gets the swing cone limit.</summary>
        public Range SwingLimit { get; }
        /// <summary>Gets whether <see cref="TwistLimit"/> is enforced.</summary>
        public bool EnableTwistLimit { get; }
        /// <summary>Gets the twist limit around the joint axis.</summary>
        public Range TwistLimit { get; }
        /// <summary>Gets whether the angular motor is enabled.</summary>
        public bool EnableAngularMotor { get; }
        /// <summary>Gets the target angular velocity driven by the angular motor.</summary>
        public Vector3 AngularTargetVelocity { get; }
        /// <summary>Gets the maximum torque the angular motor may apply.</summary>
        public float MaxTorque { get; }
        /// <summary>Gets the linear spring frequency.</summary>
        public float LinearFrequency { get; }
        /// <summary>Gets the linear spring damping ratio.</summary>
        public float LinearDampingRatio { get; }
        /// <summary>Gets the angular spring frequency.</summary>
        ...
        /// <summary>Gets the elastic damping.</summary>
        public float ElasticDamping { get; }
        /// <summary>Gets the plasticity, how much the joint drives back to its bind pose.</summary>
        public float Plasticity { get; }
        /// <summary>Gets an editor label for this joint.</summary>
