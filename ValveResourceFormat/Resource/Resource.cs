...
namespace ValveResourceFormat
{
    ...
    public class Resource : IDisposable
    {
        ...
        // Serializes deferred block materialization, the shared Reader is stateful
        ...
        public uint FullFileSize
        {
            get
            {
                ...
                // Only touch the DATA block for the types that store streaming sizes in it, so a
                // partially read resource of another type does not materialize it here
        ...
        public void Read(Stream input, in ResourceReadOptions options)
        {
            ...
            if (FileSize == ValvePak.Package.MAGIC)
            {
