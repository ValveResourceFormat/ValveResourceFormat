...
namespace GUI.Forms
{
    partial class AboutForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            website = new CustomButton();
            github = new CustomButton();
            releases = new CustomButton();
            label3 = new Label();
            icon = new PictureBox();
            keybinds = new CustomButton();
            copyVersion = new CustomButton();
        ...
        private CustomButton website;
        private CustomButton github;
        private CustomButton releases;
        private Label label3;
        private PictureBox icon;
        private CustomButton keybinds;
        private CustomButton copyVersion;
    }
}
