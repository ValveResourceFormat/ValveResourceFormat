...
namespace GUI
{
    partial class MainForm : Form
    {
        ...
        protected override void OnCreateControl()
        {
            ...
            mainTabs.BackColor = Themer.CurrentThemeColors.ControlBoxHighlight;
            mainTabs.BackColor = Themer.CurrentThemeColors.App;
            mainTabs.TabColor = Themer.CurrentThemeColors.AppMiddle;
...
#pragma warning restore CA2000
                    ...
                    ImageList.ImageSize = new Size(this.AdjustForDPI(16), this.AdjustForDPI(16));
