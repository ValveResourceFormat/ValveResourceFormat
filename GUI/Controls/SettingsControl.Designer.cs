...
namespace GUI.Forms
{
    partial class SettingsControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            gamePathsAdd = new BetterButton();
            gamePathsRemove = new BetterButton();
            gamePathsAddFolder = new BetterButton();
        ...
        private BetterButton gamePathsAdd;
        private BetterButton gamePathsRemove;
        private BetterButton gamePathsAddFolder;
        private ThemedComboBox antiAliasingComboBox;
        private BetterButton registerAssociationButton;
        private BetterButton setFovTo4by3Button;
        private ThemedComboBox themeComboBox;
        private BetterGroupBox groupBox1;
        private BetterGroupBox groupBox2;
        private BetterGroupBox groupBox3;
        private BetterGroupBox groupBox4;
    }
}
