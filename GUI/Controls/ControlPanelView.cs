...
namespace GUI.Controls
{
    class ControlPanelView : UserControl
    {
        ...
        public ThemedComboBox AddSelection(string name, Action<string, int> changeCallback, bool horizontal = false, bool fill = false)
        {
            ...
            Themer.ThemeControl(selectionControl);
