...
public class ThemedComboBox : ComboBox
{
    ...
    protected override void OnDrawItem(DrawItemEventArgs e)
    {
        ...
        using (var textBrush = new SolidBrush(foreColor))
        {
            ...
            {
                TextRenderer.DrawText(e.Graphics, text, e.Font, e.Bounds, foreColor, Color.Transparent, TextFormatFlags.HorizontalCenter);
            }
            else
            {
                TextRenderer.DrawText(e.Graphics, text, e.Font, e.Bounds, foreColor, Color.Transparent, TextFormatFlags.Left);
            }
        }
