...
#pragma warning disable WFO5001
        ...
        public partial class ShaderSyntaxHighlighter : SyntaxHighlighter
        {
            ...
            [GeneratedRegex(@"\b(?:Allow1|BoolAttribute|ByteAddressBuffer|ChildOf1|CreateInputTexture2D|DWORD|DynamicCombo|DynamicComboRule|ExternalDescriptorSet|Feature|FeatureRule|Float2Attribute|Float3Attribute|FloatAttribute|IntAttribute|RenderState|Requires1|SamplerComparisonState|SamplerState|StaticCombo|StaticComboRule|StringAttribute|StructuredBuffer|Texture1D|Texture2D|Texture2DArray|Texture3D|TextureAttribute|TextureCube|TextureCubeArray|atomic_uint|attribute|bool|bool2|bool3|bool4|break|buffer|bvec2|bvec3|bvec4|case|cbuffer|centroid|coherent|const|continue|default|discard|do|double|else|false|fixed|fixed2|fixed3|fixed4|flat|float|float1x1|float1x2|float1x3|float1x4|float2|float2x1|float2x2|float2x3|float2x4|float3|float3x1|float3x2|float3x3|float3x4|float4|float4x1|float4x2|float4x3|float4x4|for|half|half2|half3|half4|if|in|inout|int|int2|int3|int4|invariant|ivec2|ivec3|ivec4|layout|mat2|mat3|mat4|matrix|noperspective|out|patch|precise|precision|readonly|restrict|return|sample|sampler|sampler1D|sampler2D|sampler3D|samplerCube|shared|smooth|static|struct|subroutine|switch|texture|texture2D|true|uint|uint2|uint3|uint4|uniform|uvec2|uvec3|uvec4|varying|vec2|vec3|vec4|vector|void|volatile|while|writeonly)\b", RegexOptions.ExplicitCapture)]
