...
namespace GUI.Utils
{
    public static class Themer
    {
        ...
        private static readonly ThemeColors LightTheme = new()
        {
            ...
            AppSoft = Color.FromArgb(231, 236, 236),
            AppMiddle = Color.FromArgb(244, 244, 244),
        ...
        private static void ThemeControlInternal(Control control)
        {
            ...
            if (control is DataGridView grid)
            {
                ...
                grid.DefaultCellStyle.SelectionBackColor = CurrentThemeColors.AppMiddle;   //Window Cell color when not in focus or selected
