...
uniform float g_flMetalness = 1.0;
...
void main()
{
    ...
    vec4 ambient = texture(g_tColor, vTexCoordOut * g_vTexCoordScale.xy + g_vTexCoordOffset.xy);
    ...
    vec4 color = vec4(illumination * ambient.rgb * g_vColorTint.rgb, ambient.a);
