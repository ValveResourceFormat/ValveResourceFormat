...
namespace GUI.Types.ParticleRenderer
{
    abstract class ParticleFunction
    {
        ...
        static float FadeInOut(float fadeInStart, float fadeInEnd, float fadeOutStart, float fadeOutEnd, float time)
        {
        ...
        static float FLerp(float f1, float f2, float i1, float i2, float x)
        {
