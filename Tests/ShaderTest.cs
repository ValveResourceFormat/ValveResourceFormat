...
namespace Tests
{
    public class ShaderTest
    {
        ...
        public void TestVcsSourceTypes()
        {
            ...
            Assert.AreEqual(VcsFileType.PixelShader, ComputeVCSFileName(filenamepath1).Item1);
            Assert.AreEqual(VcsPlatformType.PCGL, ComputeVCSFileName(filenamepath1).Item2);
            Assert.AreEqual(VcsModelType._40, ComputeVCSFileName(filenamepath1).Item3);
            var filenamepath2 = "/sourcedir/solid_sky_pcgl_30_features.vcs";
            Assert.AreEqual(VcsFileType.Features, ComputeVCSFileName(filenamepath2).Item1);
            ...
            Assert.AreEqual(VcsModelType._30, ComputeVCSFileName(filenamepath3).Item3);
            ...
            Assert.AreEqual(VcsModelType._41, ComputeVCSFileName(filenamepath5).Item3);
            ...
            Assert.AreEqual(VcsFileType.ComputeShader, ComputeVCSFileName(filenamepath7).Item1);
            Assert.AreEqual(VcsPlatformType.VULKAN, ComputeVCSFileName(filenamepath7).Item2);
            Assert.AreEqual(VcsModelType._50, ComputeVCSFileName(filenamepath7).Item3);
            ...
            Assert.AreEqual(VcsFileType.VertexShader, ComputeVCSFileName(filenamepath9).Item1);
            Assert.AreEqual(VcsPlatformType.ANDROID_VULKAN, ComputeVCSFileName(filenamepath9).Item2);
            Assert.AreEqual(VcsModelType._40, ComputeVCSFileName(filenamepath9).Item3);
        }
    }
}
