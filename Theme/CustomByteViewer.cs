...
public class CustomByteViewer : TableLayoutPanel
{
...
#pragma warning restore CA5392 // Use DefaultDllImportSearchPaths attribute for P/Invokes
    ...
    private unsafe void InitAnsi()
    {
        ...
        {
            size = MultiByteToWideChar(CP_ACP, 0, pDataBuff, _dataBuf.Length, null, 0);
            text = new char[size + 1];
            fixed (char* pText = text)
            {
                size = MultiByteToWideChar(CP_ACP, 0, pDataBuff, size, pText, size);
            }
        }
