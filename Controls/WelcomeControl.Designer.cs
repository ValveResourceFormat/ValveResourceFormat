...
namespace GUI.Controls
{
    partial class WelcomeControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            updateCheckButton = new CustomButton();
            groupBox2 = new CustomGroupBox();
            label3 = new System.Windows.Forms.Label();
            groupBox3 = new CustomGroupBox();
            fileAssociationButton = new CustomButton();
        ...
        private CustomButton updateCheckButton;
        private CustomButton fileAssociationButton;
