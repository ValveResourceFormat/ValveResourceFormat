...
partial class StateNode : PoseNode
{
    ...
    public StateNode(KVObject data) : base(data)
    {
        ...
        EntryEvents = data.GetArray<GlobalSymbol>("m_entryEvents");
        ExecuteEvents = data.GetArray<GlobalSymbol>("m_executeEvents");
        ExitEvents = data.GetArray<GlobalSymbol>("m_exitEvents");
